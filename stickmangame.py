__author__ = 'deco <s15008@std.it-college.ac.jp>'
...
class Game:
    def __init__( self):
        ...
        self.bgs = [ PhotoImage( file='background.gif'), PhotoImage( file='background_2_green.gif'),]
        ...
        for i in range(25):
           if i % 2 == 0:
               self.canvas.create_image( i%5 * w, i//5 * h, image=self.bg, anchor='nw')

           self.canvas.create_image( i%5 * w, i//5 * h, image=self.bgs[i%2], anchor='nw')
...
class PlatformSprite( Sprite):
    ...
    def move(self):
        print( 'PlatformSprite.move()')
        self.x += 1
        self.game.canvas.itemconfig( self.image, image=self.photo_image)
        print( self.image, self.photo_image, sep=' ')
    ...
    def move(self):
        ...
        for sprite in self.game.sprites:
            ...
            if left and self.x < 0 and collided_left( co, sprite_co):
                ...
                print( '{0} endgame : {1}\n'.format( sprite.__class__, sprite.endgame))
            if right and self.x > 0 and collided_right( co, sprite_co):
                self.x = 0
                right = False
                if sprite.endgame: self.game.runnning = False
                print( '{0} endgame : {1}\n'.format( sprite.__class__, sprite.endgame))
                print( self.game.running)
